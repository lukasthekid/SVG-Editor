...
public class SVGMetaPost {
    ...
    public ObservableList<SVGPath> runPath() {
        ObservableList<SVGPath> list= FXCollections.observableArrayList();
